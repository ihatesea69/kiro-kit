...
- The npm package page now leads with the demo GIF of `init` running inside Kiro, matching the repository README. It missed the 0.10.5 publish by an hour, and npm versions are immutable, so it ships here.
