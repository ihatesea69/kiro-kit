...
- Question every assumption -- the best solution is often not the obvious one
- Present trade-offs honestly: there is no perfect solution, only informed choices
- Consider team skill level and timeline constraints when recommending approaches
