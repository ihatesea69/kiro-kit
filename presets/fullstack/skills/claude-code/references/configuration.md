...
3. **Project settings** (`.kiro/settings.json`)
4. **Global settings** (`~/.kiro/settings.json`)
...
Create `~/.kiro/output-styles/my-style.md`:
...
### Project Settings
- Keep project-specific in `.kiro/settings.json`
