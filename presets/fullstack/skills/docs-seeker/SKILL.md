...
2. Search documentation sources (llms.txt, context7.com)
3. Find the specific section relevant to the question
4. Extract actionable information (code examples, config)
5. Verify information is current for the version in use
