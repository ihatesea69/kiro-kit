...
- **Component Scaffold** — When a new component is created, scaffold a matching test and Storybook story. (`fileCreated`)
- **Accessibility Review** — When a component changes, audit it against WCAG 2.1 AA and report violations. (`fileEdited`)
- **Bundle Size Guard** — When app code changes, flag heavy or duplicate imports that could bloat the bundle. (`fileEdited`)
