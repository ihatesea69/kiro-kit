...
- **Platform Parity Check** — When a screen/widget changes, check iOS and Android behave equivalently. (`fileEdited`)
- **Asset Optimization** — When an image/asset is added, verify it is optimized and has correct density variants. (`fileCreated`)
- **Release Checklist** — Manual pre-release checklist for a store submission. (`userTriggered`)
