...
- **Platform Parity Check** — When a screen/widget changes, check iOS and Android behave equivalently. (`PostFileSave`)
- **Asset Optimization** — When an image/asset is added, verify it is optimized and has correct density variants. (`PostFileCreate`)
...
- `/release-checklist` — Run on demand for a pre-release checklist before a store submission.
