...
def find_api_key() -> Optional[str]:
    ...
    2. .kiro/skills/ai-multimodal/.env (skill-specific config)
    3. .kiro/skills/.env (shared skills config)
    4. .kiro/.env (Claude global config)
    """
    ...
    if load_dotenv:
        ...
        skill_dir = script_dir.parent  # .kiro/skills/ai-multimodal
        skills_dir = skill_dir.parent   # .kiro/skills
