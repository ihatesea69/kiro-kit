...
Kiro will automatically activate this skill when you mention payment integration, subscriptions, webhooks, or platform-specific terms (SePay, Polar).
...
```bash
cd .kiro/skills/payment-integration/scripts
