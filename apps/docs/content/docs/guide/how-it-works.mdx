---
title: "How It Works"
description: "The preset model, the init/add/update/restore lifecycle, merge semantics, conflict resolution, and backups."
---
...
and includes everything a working setup needs:
...
1. Interactive multi-pick prompt shows every available preset.
