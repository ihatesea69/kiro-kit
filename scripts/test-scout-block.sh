...
echo '{"tool_input":{"command":"ls -la"}}' | node .kiro/hooks/scout-block.js
if [ $? -eq 0 ]; then
...
echo '{"tool_input":{"command":"ls node_modules"}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"cd .git/ && ls"}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"find __pycache__"}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"cat dist/bundle.js"}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"rm -rf build/"}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"cat .env"}}' | node .kiro/hooks/scout-block.js
if [ $? -eq 0 ]; then
...
echo 'invalid json' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":""}}' | node .kiro/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
