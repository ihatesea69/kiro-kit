...
- [missing] claudekit-engineer-main/docs/code-standards.md (size_lines=949) -> presets/frontend/claudekit-engineer-main/docs/code-standards.md
- [missing] claudekit-engineer-main/docs/codebase-summary.md (size_lines=342) -> presets/frontend/claudekit-engineer-main/docs/codebase-summary.md
- [missing] claudekit-engineer-main/docs/project-overview-pdr.md (size_lines=606) -> presets/frontend/claudekit-engineer-main/docs/project-overview-pdr.md
- [missing] claudekit-engineer-main/docs/project-roadmap.md (size_lines=401) -> presets/frontend/claudekit-engineer-main/docs/project-roadmap.md
- [missing] claudekit-engineer-main/docs/system-architecture.md (size_lines=906) -> presets/frontend/claudekit-engineer-main/docs/system-architecture.md
...
- [missing] claudekit-engineer-main/docs/code-standards.md (size_lines=949) -> presets/backend/claudekit-engineer-main/docs/code-standards.md
- [missing] claudekit-engineer-main/docs/codebase-summary.md (size_lines=342) -> presets/backend/claudekit-engineer-main/docs/codebase-summary.md
- [missing] claudekit-engineer-main/docs/project-overview-pdr.md (size_lines=606) -> presets/backend/claudekit-engineer-main/docs/project-overview-pdr.md
- [missing] claudekit-engineer-main/docs/project-roadmap.md (size_lines=401) -> presets/backend/claudekit-engineer-main/docs/project-roadmap.md
- [missing] claudekit-engineer-main/docs/system-architecture.md (size_lines=906) -> presets/backend/claudekit-engineer-main/docs/system-architecture.md
...
- [missing] claudekit-engineer-main/docs/code-standards.md (size_lines=949) -> presets/fullstack/claudekit-engineer-main/docs/code-standards.md
- [missing] claudekit-engineer-main/docs/codebase-summary.md (size_lines=342) -> presets/fullstack/claudekit-engineer-main/docs/codebase-summary.md
- [missing] claudekit-engineer-main/docs/project-overview-pdr.md (size_lines=606) -> presets/fullstack/claudekit-engineer-main/docs/project-overview-pdr.md
- [missing] claudekit-engineer-main/docs/project-roadmap.md (size_lines=401) -> presets/fullstack/claudekit-engineer-main/docs/project-roadmap.md
- [missing] claudekit-engineer-main/docs/system-architecture.md (size_lines=906) -> presets/fullstack/claudekit-engineer-main/docs/system-architecture.md
...
- [missing] claudekit-engineer-main/docs/code-standards.md (size_lines=949) -> presets/mobile/claudekit-engineer-main/docs/code-standards.md
- [missing] claudekit-engineer-main/docs/codebase-summary.md (size_lines=342) -> presets/mobile/claudekit-engineer-main/docs/codebase-summary.md
- [missing] claudekit-engineer-main/docs/project-overview-pdr.md (size_lines=606) -> presets/mobile/claudekit-engineer-main/docs/project-overview-pdr.md
- [missing] claudekit-engineer-main/docs/project-roadmap.md (size_lines=401) -> presets/mobile/claudekit-engineer-main/docs/project-roadmap.md
- [missing] claudekit-engineer-main/docs/system-architecture.md (size_lines=906) -> presets/mobile/claudekit-engineer-main/docs/system-architecture.md
...
- [missing] claudekit-engineer-main/docs/code-standards.md (size_lines=949) -> presets/devops/claudekit-engineer-main/docs/code-standards.md
- [missing] claudekit-engineer-main/docs/codebase-summary.md (size_lines=342) -> presets/devops/claudekit-engineer-main/docs/codebase-summary.md
- [missing] claudekit-engineer-main/docs/project-overview-pdr.md (size_lines=606) -> presets/devops/claudekit-engineer-main/docs/project-overview-pdr.md
- [missing] claudekit-engineer-main/docs/project-roadmap.md (size_lines=401) -> presets/devops/claudekit-engineer-main/docs/project-roadmap.md
- [missing] claudekit-engineer-main/docs/system-architecture.md (size_lines=906) -> presets/devops/claudekit-engineer-main/docs/system-architecture.md
...
- [missing] claudekit-engineer-main/docs/code-standards.md (size_lines=949) -> presets/data-ai/claudekit-engineer-main/docs/code-standards.md
- [missing] claudekit-engineer-main/docs/codebase-summary.md (size_lines=342) -> presets/data-ai/claudekit-engineer-main/docs/codebase-summary.md
- [missing] claudekit-engineer-main/docs/project-overview-pdr.md (size_lines=606) -> presets/data-ai/claudekit-engineer-main/docs/project-overview-pdr.md
- [missing] claudekit-engineer-main/docs/project-roadmap.md (size_lines=401) -> presets/data-ai/claudekit-engineer-main/docs/project-roadmap.md
- [missing] claudekit-engineer-main/docs/system-architecture.md (size_lines=906) -> presets/data-ai/claudekit-engineer-main/docs/system-architecture.md
...
- [category-skip] claudekit-engineer-main/docs/code-standards.md (reason: frontend+backend+fullstack+mobile+devops+data-ai-only)
- [category-skip] claudekit-engineer-main/docs/codebase-summary.md (reason: frontend+backend+fullstack+mobile+devops+data-ai-only)
- [category-skip] claudekit-engineer-main/docs/project-overview-pdr.md (reason: frontend+backend+fullstack+mobile+devops+data-ai-only)
- [category-skip] claudekit-engineer-main/docs/project-roadmap.md (reason: frontend+backend+fullstack+mobile+devops+data-ai-only)
- [category-skip] claudekit-engineer-main/docs/system-architecture.md (reason: frontend+backend+fullstack+mobile+devops+data-ai-only)
