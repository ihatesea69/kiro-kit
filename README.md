...
| `backend` | Node, Python, Go APIs | 24 agents, 25 skills, 67 commands for API design, database management, auth, deployment patterns, deep security scanning |
| `fullstack` | Next.js, T3 stack | 25 agents, 31 skills, 74 commands covering frontend plus backend, payment integration, e-commerce, deep security scanning |
| `mobile` | Flutter, React Native | 23 agents, 28 skills, 71 commands for mobile-first patterns, ai-multimodal, ui-styling |
| `devops` | Docker, Kubernetes, Terraform | 25 agents, 27 skills, 66 commands for CI checks, container scanning, infrastructure as code, deep security scanning |
...
| `sa` | Cloud architecture, draw.io, IaC | 25 agents, 28 skills, 69 commands for architecture diagrams (draw.io + Mermaid), SAD documents (.docx), decks (.pptx), CloudFormation + Terraform, Well-Architected reviews |
